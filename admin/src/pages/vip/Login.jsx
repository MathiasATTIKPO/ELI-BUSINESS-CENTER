...
export default function VIPLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setTimeout(() => {
          if (user && user.forcePasswordChange) navigate('/vip/change-password', { replace: true })
          else navigate('/vip/dashboard', { replace: true })
        }, 1000)
      }
    } catch (error) {
  ...
  return (
    <div className="relative flex min-h-screen min-h-[100dvh] items-start justify-center overflow-x-hidden overflow-y-auto bg-gradient-to-br from-amber-900 via-orange-900 to-amber-900 px-4 py-6 sm:items-center sm:py-8">
      {/* Cercles décoratifs */}
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-white/20 bg-white/95 p-6 shadow-2xl backdrop-blur-xl animate-fadeIn sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            <label htmlFor="vip-phone" className="text-sm font-semibold text-gray-700 flex items-center gap-2">
          ...
          <div className="space-y-2">
            <label htmlFor="vip-password" className="text-sm font-semibold text-gray-700 flex items-center gap-2">
            ...
            <div className="relative group">
              ...
              <button
                ...
                className="absolute right-1 top-1/2 -translate-y-1/2 rounded-lg p-2 text-gray-400 transition-colors hover:text-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500"
